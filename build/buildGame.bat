...
set _NT_DEBUG_HEAP=1 

@REM set FLAGS= -EHsc -Zi -O2 -DRELEASE_BUILD
set FLAGS= -EHsc -Zi -O2 
...
set COMMAND= cl %FLAGS% %CODEPATHS% %INCLUDES% %LIBRARIES% /Fe"%DIRECTORY_NAME%\badpaint.exe"
