...
UiBlock *CreateBrushEffectButton(BRUSH_EFFECT brushEffect, String string, UiFont uiFont, ColorU32 baseColor, COMMAND command, Brush *currentBrush, CommandInput *commandInputs)
{
	...
	UiBlock *result = CreateUiButton(string, hash, uiFont, uiColorStates, active, false, commandInputs);
