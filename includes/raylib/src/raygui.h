...
static RayFong guiFont = { 0 };                    // Gui current font (WARNING: highly coupled to raylib)
...
//-------------------------------------------------------------------------------
static RayFong GetFontDefault(void);                            // -- GuiLoadStyleDefault()
static RayFong LoadFontEx(const char *fileName, int fontSize, int *codepoints, int codepointCount); // -- GuiLoadStyle(), load font
...
// Set custom gui font
// NOTE: RayFong loading/unloading is external to raygui
void GuiSetFont(RayFong font)
{
